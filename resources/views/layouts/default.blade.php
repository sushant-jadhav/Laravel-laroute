...
<head>
    <meta charset="UTF-8">
    <title>{{ $page_title or "My Dashboard" }}</title>
    ...
    <link href="{{ asset("assets/plugins/datatables/jquery.dataTables.css")}}" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="{{asset("api/app.js")}}"></script>
<script type="text/javascript" src="{{asset("api/user/userservice.js")}}"></script>
